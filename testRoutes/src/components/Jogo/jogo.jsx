...
const Jogo = ({ id, game_name, image, discount, price, company, selectEdit, deleteGame}) => {
  // const comprandoAux = () => {
  //   Comprando(game_name);
  // }
  ...
  return (
      <div className="pointer game-container flex-column align-container-center">
        ...
        <h4 className="white game-name mont-500">{ company }</h4>
        ...
        <div className="flex-column actions">
          ...
          <button className="pointer transition delete-btn"  onClick={() => { deleteGame(id)}}>Excluir</button>
        </div>
      </div>
  )
}
